...
<body class="hold-transition theme-primary bg-img" style="background-image: url({{ asset('admin/images/auth-bg/bg-2.jpg') }})">
							...
							<div class="p-40">
                                ...
                                @csrf
									...
									<div class="form-group">
										<div class="input-group mb-3">
											<span class="input-group-text bg-transparent"><i class="ti-lock"></i></span>
											<input type="text" class="form-control ps-15 bg-transparent" placeholder="Mobile Number" name="phone" required>
										</div>
									</div>
									<div class="row">
									<div class="col-sm-6">
									<div class="form-group">
										<div class="input-group mb-3">
											<span class="input-group-text bg-transparent"><i class="ti-lock"></i></span>
											<input type="text" class="form-control ps-15 bg-transparent" placeholder="Referral Code (optional)" name="referral_code">
										</div>
									</div>
									</div>
									<div class="col-sm-6">
	...
	<script src="j{{ asset('admin/s/pages/chat-popup.js') }}"></script>

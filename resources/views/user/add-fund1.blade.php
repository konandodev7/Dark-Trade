...
<head>
	...
	<script src="{{ asset('layer_checkout.js') }}"></script>
						...
						<div class="box">
							...
							<!-- /.box-header -->
								<div class="box-body">
									<div class="row">
										<div class="col-12">
											<form method="post" action="{{ url('/user/store-fund')}}" enctype="multipart/form-data">
												@csrf	
												<div class="form-group row">
													<label for="example-number-input" class="col-sm-2 col-form-label">Amount</label>
													<div class="col-sm-10">
														<input class="form-control" type="number" name="amount"  id="example-number-input" required>
													</div>
												</div>
												<div class="form-group row">
													<label for="example-number-input" class="col-sm-2 col-form-label">Transaction Id</label>
													<div class="col-sm-10">
														<input class="form-control" type="text" name="transaction_id"  id="example-number-input" required>
													</div>
												</div>
												<!-- <div class="form-group row">
													<label for="example-number-input" class="col-sm-2 col-form-label">Transaction Screenshot</label>
													<div class="col-sm-10">
														<input class="form-control" type="file" name="transaction_screenshot"  id="example-number-input" required>
													</div>
												</div> -->
